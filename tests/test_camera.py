...
@pytest.mark.parametrize("camera_position,point_to_fix,horizontal_rotation,normal,up,horizontal",
    [
...
def test_camera_orientation(camera_position, point_to_fix, horizontal_rotation, normal, up, horizontal):
    camera = Camera(camera_position=camera_position, point_to_fix=point_to_fix, horizontal_rotation=horizontal_rotation)
...
@pytest.mark.parametrize("camera_position,point_to_fix,horizontal_rotation,move_sequence,expected_camera_point,atol",
    [
...
def test_camera_movement(camera_position, point_to_fix, horizontal_rotation, move_sequence, expected_camera_point, atol):
    camera = Camera(camera_position=camera_position, point_to_fix=point_to_fix, horizontal_rotation=horizontal_rotation)
